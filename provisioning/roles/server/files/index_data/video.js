...
var Player = (function (_Component) {
   ...
   * ```js
   *     myPlayer.src("https://web.archive.org/web/20220302070018/http://www.example.com/path/to/video.mp4");
   * ```
   * **Source Object (or element):* * A javascript object containing information
   * about the source file. Use this method if you want the player to determine if
   * it can support the file using the type information.
   * ```js
   *     myPlayer.src({ type: "video/mp4", src: "https://web.archive.org/web/20220302070018/http://www.example.com/path/to/video.mp4" });
   * ```
   ...
   * ```js
   *     myPlayer.src([
   *       { type: "video/mp4", src: "https://web.archive.org/web/20220302070018/http://www.example.com/path/to/video.mp4" },
   *       { type: "video/webm", src: "https://web.archive.org/web/20220302070018/http://www.example.com/path/to/video.webm" },
   *       { type: "video/ogg", src: "https://web.archive.org/web/20220302070018/http://www.example.com/path/to/video.ogv" }
   *     ]);
   * ```
   *
   ...
   *     // set
   *     myPlayer.poster('https://web.archive.org/web/20220302070018/http://example.com/myImage.jpg');
   * ```
   *
...
var Flash = (function (_Tech) {
  ...
  Flash.prototype.createEl = function createEl() {
    ...
    if (!options.swf) {
      options.swf = '//web.archive.org/web/20220302070018/https://vjs.zencdn.net/swf/5.0.1/video-js.swf';
    }
  ...
  Tech.prototype.emulateTextTracks = function emulateTextTracks() {
    ...
    if (!_globalWindow2['default']['WebVTT'] && this.el().parentNode != null) {
      (function () {
        ...
        script.src = _this.options_['vtt.js'] || 'https://web.archive.org/web/20220302070018/https://cdn.rawgit.com/gkatsev/vtt.js/vjs-v0.12.1/dist/vtt.min.js';
...
!function(){!function(a){var b=a&&a.videojs;if(b){b.CDN_VERSION="5.9.2";var c="https:"===a.location.protocol?"https://":"http://";b.options.flash.swf=c+"vjs.zencdn.net/swf/5.0.1/video-js.swf"}}(window),function(a,b,c,d,e,f,g){b&&b.HELP_IMPROVE_VIDEOJS!==!1&&(e.random()>.01||(f=b.location,g=b.videojs||{},a.src="//web.archive.org/web/20220302070018/https://www.google-analytics.com/__utm.gif?utmwv=5.4.2&utmac=UA-16505296-3&utmn=1&utmhn="+d(f.hostname)+"&utmsr="+b.screen.availWidth+"x"+b.screen.availHeight+"&utmul="+(c.language||c.userLanguage||"").toLowerCase()+"&utmr="+d(f.href)+"&utmp="+d(f.hostname+f.pathname)+"&utmcc=__utma%3D1."+e.floor(1e10*e.random())+".1.1.1.1%3B&utme=8(vjsv*cdnv)9("+g.VERSION+"*"+g.CDN_VERSION+")"))}(new Image,window,navigator,encodeURIComponent,Math)}();

}
/*
     FILE ARCHIVED ON 07:00:18 Mar 02, 2022 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  captures_list: 166.882
  exclusion.robots: 0.103
  exclusion.robots.policy: 0.095
  RedisCDXSource: 0.542
  esindex: 0.008
  LoadShardBlock: 53.255 (3)
  PetaboxLoader3.datanode: 465.779 (5)
  CDXLines.iter: 37.758 (3)
  load_resource: 718.362 (2)
  PetaboxLoader3.resolve: 210.651 (2)
*/